...
import 'message_employee_model.dart';
export 'message_employee_model.dart';

class MessageEmployeeWidget extends StatefulWidget {
  const MessageEmployeeWidget({super.key});

  @override
  State<MessageEmployeeWidget> createState() => _MessageEmployeeWidgetState();
}

class _MessageEmployeeWidgetState extends State<MessageEmployeeWidget> {
  late MessageEmployeeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MessageEmployeeModel());
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Send individual messages for employees',
