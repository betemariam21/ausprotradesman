...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'shiftScedulePage',
          path: '/shiftScedulePage',
          builder: (context, params) => ShiftScedulePageWidget(),
        ),
        FFRoute(
          name: 'sceduleHistory',
          path: '/sceduleHistory',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'sceduleHistory')
              : SceduleHistoryWidget(),
        ),
        FFRoute(
          name: 'shiftDetailsPage',
          path: '/shiftDetailsPage',
          asyncParams: {
            'schedule': getDoc(['users', 'driverDailySchedule'],
                DriverDailyScheduleRecord.fromSnapshot),
          },
          builder: (context, params) => ShiftDetailsPageWidget(
        ...
        FFRoute(
          name: 'notApprovedPage',
          path: '/notApprovedPage',
          builder: (context, params) => NotApprovedPageWidget(),
        ),
        FFRoute(
          name: 'onBoardingPage',
          path: '/onBoardingPage',
        ...
        FFRoute(
          name: 'deviceChange',
          path: '/deviceChange',
          builder: (context, params) => DeviceChangeWidget(),
        )
